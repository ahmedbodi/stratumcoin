...
"""Verify that starting stratumcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start stratumcoin with -h for help text")
        ...
        self.log.info("Start stratumcoin with -version for version information")
        ...
        self.log.info("Start stratumcoind with -fakearg to make sure it does not start")
