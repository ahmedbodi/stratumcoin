...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 120; // BIP34 activated on regtest (Used in functional tests)
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = 120; // BIP65 activated on regtest (Used in functional tests)
        consensus.BIP66Height = 120; // BIP66 activated on regtest (Used in functional tests)
        consensus.CSVHeight = 120; // CSV activated on regtest (Used in rpc activation tests)
        consensus.SegwitHeight = 0; // SEGWIT is always activated on regtest unless overridden
        consensus.MinBIP9WarningHeight = 0;
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 60; // 3.5 days
        ...
        genesis = CreateGenesisBlock(1419368971, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x666e3e9081753d3b768dca257f43470bceedc8c35187158d0117b575316ec00e"));
        ...
        checkpointData = {
            {
                {0, uint256S("000001a50e6c4460aa75f6e31ef3c74383e7d46f1a904f96c4952f10b9a465e5")},
            }
        };
