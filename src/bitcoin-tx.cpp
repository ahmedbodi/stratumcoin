...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " stratumcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  stratumcoin-tx [options] <hex-tx> [commands]  Update hex-encoded stratumcoin transaction\n" +
            "or:     stratumcoin-tx [options] -create [commands]   Create hex-encoded stratumcoin transaction\n" +
            "\n";
