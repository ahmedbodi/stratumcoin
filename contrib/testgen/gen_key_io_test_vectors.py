...
bech32_templates = [
  ...
  ('stc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('stc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('stc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('stc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tstc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tstc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tstc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tstc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tstc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tstc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tstc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tstc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rstc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rstc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rstc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rstc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tstc',   17, 32, Encoding.BECH32M, False, False, False),
  ('rstc',  3,  1, Encoding.BECH32M, False, False, False),
  ('stc',   15, 41, Encoding.BECH32M, False, False, False),
  ('tstc',    0, 16, Encoding.BECH32,  False, False, False),
  ('rstc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('stc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tstc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rstc',  0, 20, Encoding.BECH32,  False, False, True),
  ('stc',    0, 20, Encoding.BECH32M, False, False, False),
  ('tstc',    0, 32, Encoding.BECH32M, False, False, False),
  ('rstc',  0, 20, Encoding.BECH32M, False, False, False),
  ('stc',    1, 32, Encoding.BECH32,  False, False, False),
  ('tstc',    2, 16, Encoding.BECH32,  False, False, False),
  ('rstc', 16, 20, Encoding.BECH32,  False, False, False),
]
