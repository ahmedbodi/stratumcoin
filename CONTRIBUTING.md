Contributing to Stratumcoin Core
============================

The Stratumcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Stratumcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/stratumcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to stratumcoin-qt
...
The following applies to code changes to the Stratumcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Stratumcoin
Network Protocol consensus changes.

Whether a pull request is merged into Stratumcoin Core rests with the project merge
...
Patches that change Stratumcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Stratumcoin consensus, it must have been
...
The project leader is the release manager for each Stratumcoin Core release.
