# Support for Output Descriptors in Stratumcoin Core

Since Stratumcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `stc1...` for mainnet or `tstc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Stratumcoin Core wallets, a convenience function `combo` is
