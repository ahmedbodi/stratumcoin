Stratumcoin Core version *0.15.1* is now available from:

  <https://download.stratumcoin.org/stratumcoin-0.15.1/>
...
A number of changes to the way Stratumcoin Core deals with peer connections and invalid blocks
